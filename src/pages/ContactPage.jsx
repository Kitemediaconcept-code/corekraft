    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-[#ECE7E8] text-center space-y-2">
          <div className="w-12 h-12 bg-[#FFF3F6] text-[#EE3364] rounded-2xl flex items-center justify-center mx-auto">
            <PhoneCall size={22} />
          </div>
      ...
      <div className="bg-white p-8 rounded-3xl border border-[#ECE7E8] shadow-sm max-w-2xl mx-auto">
        {submitted ? (
          <div className="text-center py-8 space-y-3">
            <CheckCircle2 size={40} className="text-[#EE3364] mx-auto" />
          ...
          <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input type="text" placeholder="Your Name" required className="w-full text-xs p-3 rounded-xl border border-gray-200 outline-none focus:border-[#EE3364]" />
              <input type="email" placeholder="Email Address" required className="w-full text-xs p-3 rounded-xl border border-gray-200 outline-none focus:border-[#EE3364]" />
            </div>
            <textarea rows="4" placeholder="Your message..." required className="w-full text-xs p-3 rounded-xl border border-gray-200 outline-none focus:border-[#EE3364]"></textarea>
            <button type="submit" className="w-full bg-[#EE3364] text-white font-bold py-3 rounded-full hover:bg-[#D92756] transition">
              Send Message
            </button>
          </form>
        )}
